...
import vn.ztech.software.ecomSeller.api.request.SearchOrderByIdRequest
import vn.ztech.software.ecomSeller.api.request.SearchOrderByNameRequest
import vn.ztech.software.ecomSeller.model.Order
import java.lang.Exception

class SearchOrderByNamePagingSource(val request: SearchOrderByNameRequest, private val orderApi: IOrderApi): PagingSource<Int, Order>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Order> {
        return try {
            ...
            val response = orderApi.searchByUserName(request)
