...
enum class SignUpViewErrors { NONE, ERR_EMAIL, ERR_MOBILE, ERR_EMAIL_MOBILE, ERR_EMPTY, ERR_NOT_ACC, ERR_PWD12NS, ERR_PW_INVALID, ERR_PROVINCE_EMPTY, ERR_DISTRICT_EMPTY, ERR_WARD_EMPTY, ERR_DETAILED_ADDRESS_EMPTY, NAME, SHOP_NAME }
