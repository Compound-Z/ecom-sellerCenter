...
class SearchOrderByIdPagingSource(val request: SearchOrderByIdRequest, private val orderApi: IOrderApi): PagingSource<Int, Order>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Order> {
        return try {
            ...
            val response = orderApi.searchByOrderId(request)
